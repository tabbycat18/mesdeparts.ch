...
const TRANSLATIONS = {
  ...
  boardModeDetail1: {
    fr: "Backend GTFS/Neon avec cache partagé ; idéal si l’écran reste ouvert.",
    de: "GTFS/Neon-Backend mit gemeinsamem Cache; ideal, wenn der Bildschirm offen bleibt.",
    it: "Backend GTFS/Neon con cache condivisa; ideale con schermo aperto.",
    en: "GTFS/Neon backend with shared cache; ideal when the screen stays open.",
  },
  boardModeDetail2: {
    fr: "Même backend GTFS mais rafraîchi plus souvent pour un check ponctuel.",
    de: "Gleiches GTFS-Backend, aber häufiger aktualisiert für kurze Abfragen.",
    it: "Stesso backend GTFS ma aggiornato più spesso per consultazioni rapide.",
    en: "Same GTFS backend, refreshed more often for quick checks.",
  },
  boardModeFootnote1: {
    fr: "Stop_id issus du feed GTFS (Neon/PostgreSQL) uniquement. Aucun fallback transport.opendata.ch.",
    de: "Verwendet nur GTFS-Stop-IDs aus Neon/PostgreSQL. Kein transport.opendata.ch-Fallback.",
    it: "Usa solo gli stop_id GTFS da Neon/PostgreSQL. Nessun fallback su transport.opendata.ch.",
    en: "Uses GTFS stop_ids from Neon/PostgreSQL only. No transport.opendata.ch fallback.",
  },
  boardModeFootnote2: {
    fr: "Mode OFF = mêmes données GTFS, sans cache partagé ; rafraîchi plus souvent.",
    de: "Modus OFF = dieselben GTFS-Daten ohne gemeinsamen Cache; wird häufiger aktualisiert.",
    it: "Modalità OFF = stessi dati GTFS, senza cache condivisa; aggiornamenti più frequenti.",
    en: "Mode OFF = same GTFS data, no shared cache; refreshes more often.",
  },
  boardModeOk: {
    fr: "OK",
    de: "OK",
  ...
  infoHelpItemData: {
    fr: "Données : GTFS statique + GTFS-RT (backend Neon/PostgreSQL). En cas de doute : affichage officiel/sur place.",
    de: "Daten: GTFS-Static + GTFS-RT (Neon/PostgreSQL-Backend). Bei Zweifel: offizielle Anzeige vor Ort prüfen.",
    it: "Dati: GTFS static + GTFS-RT (backend Neon/PostgreSQL). In dubbio: controlla l’affissione ufficiale.",
    en: "Data: GTFS static + GTFS-RT from the Neon/PostgreSQL backend. If unsure, check the official display.",
  },
  infoIntro: {
  ...
  disclaimerBody: {
    fr: "Les données proviennent du backend GTFS (Neon/PostgreSQL) et peuvent différer de l’affichage officiel. En cas de doute, vérifiez auprès de l’exploitant ou sur place.",
    de: "Die Daten stammen aus dem GTFS-Backend (Neon/PostgreSQL) und können vom offiziellen Aushang abweichen. Im Zweifel bitte Betreiber oder Anzeige vor Ort prüfen.",
    it: "I dati provengono dal backend GTFS (Neon/PostgreSQL) e possono differire dalle indicazioni ufficiali. In dubbio, verifica presso l’operatore o sul posto.",
    en: "Data comes from the GTFS backend (Neon/PostgreSQL) and may differ from official displays. If in doubt, check with the operator or on site.",
  },
  delaysTitle: {
  ...
  creditsData: {
    fr: "Données : GTFS statique + GTFS-RT (Neon/PostgreSQL)",
    de: "Daten: GTFS-Static + GTFS-RT (Neon/PostgreSQL)",
    it: "Dati: GTFS static + GTFS-RT (Neon/PostgreSQL)",
    en: "Data: GTFS static + GTFS-RT (Neon/PostgreSQL)",
  },
  creditsAuthor: {
  ...
  footerNote: {
    fr: "Données : GTFS statique + GTFS-RT (Neon) — Horloge : sbbUhr (Apache 2.0) — Non officiel, aucune affiliation avec CFF/SBB/FFS ou les exploitants.",
    de: "Daten: GTFS-Static + GTFS-RT (Neon) — Uhr: sbbUhr (Apache License 2.0) — Inoffiziell, keine Zugehörigkeit zu SBB/CFF/FFS oder Betreibern.",
    it: "Dati: GTFS static + GTFS-RT (Neon) — Orologio: sbbUhr (Apache 2.0) — Non ufficiale, nessuna affiliazione con FFS/SBB/CFF o operatori.",
    en: "Data: GTFS static + GTFS-RT (Neon backend) — Clock: sbbUhr (Apache 2.0) — Unofficial; no affiliation with SBB/CFF/FFS or operators.",
  },
