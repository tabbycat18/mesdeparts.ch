...
const state = {
  ...
  // - getCurrentStop(): provided by main.v2026-02-20.js -> returns { id, name } from appState.
  // - onSelectStop(arg1, arg2): provided by main.v2026-02-20.js -> supports `(id, name)` and legacy payloads.
  // - favorites storage: loadFavorites()/saveFavorites() from favourites.v2026-02-20.js.
  callbacks: {
