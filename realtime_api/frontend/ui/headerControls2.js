...
import { fetchStationSuggestions, fetchStationsNearby, isAbortError } from "../v20260228-1.logic.js";
import { loadFavorites, saveFavorites } from "../v20260228-1.favourites.js";
import { getHasSeenThreeDotsTip, setHasSeenThreeDotsTip } from "../v20260228-1.threeDotsTip.js";
import { t, setLanguage, LANGUAGE_OPTIONS, applyStaticTranslations } from "../v20260228-1.i18n.js";
...
const state = {
  ...
  // - getCurrentStop(): provided by v20260228-1.main.js -> returns { id, name } from appState.
  // - onSelectStop(arg1, arg2): provided by v20260228-1.main.js -> supports `(id, name)` and legacy payloads.
  // - favorites storage: loadFavorites()/saveFavorites() from v20260228-1.favourites.js.
  callbacks: {
