...
import { fetchStationSuggestions, fetchStationsNearby, isAbortError } from "../v20260301.logic.js";
import { loadFavorites, saveFavorites } from "../v20260301.favourites.js";
import { getHasSeenThreeDotsTip, setHasSeenThreeDotsTip } from "../v20260301.threeDotsTip.js";
import { t, setLanguage, LANGUAGE_OPTIONS, applyStaticTranslations } from "../v20260301.i18n.js";
...
const state = {
  ...
  // - getCurrentStop(): provided by v20260301.main.js -> returns { id, name } from appState.
  // - onSelectStop(arg1, arg2): provided by v20260301.main.js -> supports `(id, name)` and legacy payloads.
  // - favorites storage: loadFavorites()/saveFavorites() from v20260301.favourites.js.
  callbacks: {
